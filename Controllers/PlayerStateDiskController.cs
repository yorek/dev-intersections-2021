...
[ApiController]
[Route("[controller]")]
public class PlayerStateDiskController : ControllerBase
{
        private readonly ILogger<PlayerStateDiskController> _logger;
        private readonly IConfiguration _config;

        public PlayerStateDiskController(IConfiguration config, ILogger<PlayerStateDiskController> logger)
        {
            _logger = logger;
            _config = config;
        }        
